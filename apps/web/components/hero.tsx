        ...
        <div className="w-full">
          <div className="text-center">
            ...
            <p className="m mx-auto max-w-3xl text-muted-foreground lg:text-xl">
              Cuse is the all in one toolkit for implementing computer use for your AI agents.
              Seamlessly empower AI agents to interact with computers just like humans do.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              <Button size="lg" onClick={() => navigator.clipboard.writeText("npx @cuse/cli init")}>
                npx @cuse/cli init
