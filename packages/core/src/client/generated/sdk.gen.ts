...
import type { EditorViewFileData, EditorViewFileError, EditorViewFileResponse, EditorCreateFileData, EditorCreateFileError, EditorCreateFileResponse, EditorReplaceStringData, EditorReplaceStringError, EditorReplaceStringResponse, EditorInsertTextData, EditorInsertTextError, EditorInsertTextResponse, ComputerTakeScreenshotData, ComputerTakeScreenshotError, ComputerTakeScreenshotResponse, ComputerPressKeyData, ComputerPressKeyError, ComputerPressKeyResponse, ComputerTypeTextData, ComputerTypeTextError, ComputerTypeTextResponse, ComputerMoveCursorData, ComputerMoveCursorError, ComputerMoveCursorResponse, ComputerLeftClickData, ComputerLeftClickError, ComputerLeftClickResponse, ComputerRightClickData, ComputerRightClickError, ComputerRightClickResponse, ComputerMiddleClickData, ComputerMiddleClickError, ComputerMiddleClickResponse, ComputerDoubleClickData, ComputerDoubleClickError, ComputerDoubleClickResponse, ComputerGetCursorPositionData, ComputerGetCursorPositionError, ComputerGetCursorPositionResponse, BashExecuteCommandData, BashExecuteCommandError, BashExecuteCommandResponse } from './types.gen';
 ...
 */
export const editorUndoLastEdit = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
 ...
 */
export const bashRestartSystem = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<void, unknown, ThrowOnError>({
        ...options,
        url: '/bash/restart'
    });
