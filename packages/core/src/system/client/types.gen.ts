...
export type ComputerScrollData = {
  body: {
    /**
     * Number of clicks to scroll. Positive values scroll up, negative values scroll down.
     */
    clicks: number;
    /**
     * Display number on which to perform the scroll operation.
     */
    display_num?: number;
  };
};

export type ComputerScrollResponse = void;

export type ComputerScrollError = HTTPError;
