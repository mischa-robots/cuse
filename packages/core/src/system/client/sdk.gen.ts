...
import type {
  ...
  ComputerLeftClickDragData,
  ComputerLeftClickDragError,
  ComputerLeftClickDragResponse,
  ComputerGetCursorPositionData,
  ComputerGetCursorPositionError,
  ComputerGetCursorPositionResponse,
  ComputerScrollData,
  ComputerScrollError,
  ComputerScrollResponse,
  EditorViewFileData,
  EditorViewFileError,
  ...
  EditorUndoLastEditData,
  BashExecuteCommandData,
  BashExecuteCommandError,
  BashExecuteCommandResponse,
  BashGetProcessOutputData,
  BashGetProcessOutputError,
  BashGetProcessOutputResponse,
  BashTerminateProcessData,
  BashTerminateProcessError,
  BashTerminateProcessResponse,
  BashListManagedProcessesError,
  BashListManagedProcessesResponse,
  BashListSystemProcessesError,
  BashListSystemProcessesResponse,
  BashRestartSystemData,
  BashRestartSystemError,
  BashRestartSystemResponse,
} from './types.gen';
 ...
 */
export const computerLeftClickDrag = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<ComputerLeftClickDragData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    ComputerLeftClickDragResponse,
    ComputerLeftClickDragError,
...
/**
 * Scroll mouse wheel
 * Performs a mouse wheel scroll operation on the specified display.
 */
export const computerScroll = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<ComputerScrollData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    ComputerScrollResponse,
    ComputerScrollError,
...
export const editorUndoLastEdit = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<EditorUndoLastEditData, ThrowOnError>
) => {
 ...
 */
export const bashGetProcessOutput = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<BashGetProcessOutputData, ThrowOnError>
) => {
  return (options?.client ?? client).get<
    BashGetProcessOutputResponse,
    BashGetProcessOutputError,
 ...
 */
export const bashTerminateProcess = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<BashTerminateProcessData, ThrowOnError>
) => {
 ...
 */
export const bashListManagedProcesses = <ThrowOnError extends boolean = false>(
 ...
 */
export const bashListSystemProcesses = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<unknown, ThrowOnError>
) => {
  return (options?.client ?? client).get<
    BashListSystemProcessesResponse,
...
export const bashRestartSystem = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<BashRestartSystemData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    BashRestartSystemResponse,
    BashRestartSystemError,
